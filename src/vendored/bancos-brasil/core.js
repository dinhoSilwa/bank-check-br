/**
 * Vendored from @edusites/bancos-brasil@1.2.0
 * License: MIT (Eduardo Sites - https://lecdt.com)
 * Only core.js + icones.js are vendored (SvgBanco.js excluded — requires Vue).
 * See: https://github.com/eduardolecdt/bancos-brasil
 */
